...
<pre>
   ...
   puppet-sync -s [options]
    -b, --branch BRANCH              Specify the git branch to clone.
    -s, --stdin                      Retrieve branch and revision information from stdin.
    -p, --puppetmaster HOST          Specify the host to deploy to.
    ...
    -W, --password STRING            Password for connecting to the puppetmaster.
